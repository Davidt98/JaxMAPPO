...
class RSSM(nj.Module):
  ...
  def observe(self, embed, action, state=None):
    if self._nonrecurrent_enc:
      return self.observe_nonrecurrent_enc(embed, action, state)
    else:
      return self.observe_recurrent_enc(embed, action, state)

  def observe_recurrent_enc(self, embed, action, state=None):
    """
    embed.shape (b, t, dim)
